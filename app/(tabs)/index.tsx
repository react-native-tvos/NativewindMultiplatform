...
const App = () => {
  ...
  return (
    <View className="flex-1 justify-center items-center gap-[1vh] p-[3vh] pt-[10vh] bg-[--color-background]">
      ...
      <View className="w-[90vw] flex-row gap-[5vw]">
        ...
        <View className="flex-1 justify-center items-center">
          ...
          />
          <ThemedText type={ThemedTextType.tiny}>translate-x-[3vw]</ThemedText>
        </View>
        <View className="w-[20vw] justify-center items-center">
          <Image
            source={require('@/assets/images/react-logo.png')}
